...
KBRANCH_pcx86-64 ?= "standard/base"
...
SRCREV_machine_pcx86-64 ?= "fe0fb8da3d633d802776081e7ff2df73ff2983f2"
...
# BK 170501 really need defconfig to be different for each target arch. ***TO DO***
# ref: meta/classes/kernel-yocto.bbclass (inherited via linux-quirky.inc) -- note python code, will not overwrite defconfig defined here.
...
# BK 170529 added pcx86...
COMPATIBLE_MACHINE = "qemuarm|qemuarm64|qemux86|qemuppc|qemumips|qemumips64|qemux86-64|pcx86-64|pcx86"
...
KERNEL_FEATURES_append_pcx86-64=" cfg/sound.scc cfg/paravirt_kvm.scc"
