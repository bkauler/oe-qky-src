...
inherit waf-samba cpan-base perlnative update-rc.d
# ...BK removed 'systemd'

# remove default added RDEPENDS on perl
RDEPENDS_${PN}_remove = "perl"

# BK add 'cups acl openldap gnutls nss nspr'...
DEPENDS += "krb5 readline virtual/libiconv zlib popt libtalloc libtdb libtevent libldb libbsd libaio cups acl openldap gnutls nss nspr"
# ...BK removed 'libpam krb5' ...restored 'krb5'
...
# BK remove 'systemd' and 'zeroconf' (latter causes 'avahi' pkg to be added). comment out entire line...
#PACKAGECONFIG ??= "${@bb.utils.filter('DISTRO_FEATURES', 'systemd zeroconf', d)} \
#                   acl cups ldap \
#"
# BK...
PACKAGECONFIG_append = " acl cups ldap"
# ...BK have not added 'cyrus-sasl' as has systemd dep
...
# BK remove: --with-pam --with-pammodulesdir=${base_libdir}/security
# BK change to --without-pam, --enable-gnutls
# BK removed --with-system-mitkrb5 ...restored
...
# BK removed ${systemd_system_unitdir}/nmb.service \
...
# BK removed ${libdir}/winbind_krb5_locator.so ...restored
# BK removed ${systemd_system_unitdir}/winbind.service
...
# BK removed ${libdir}/samba/smbspool_krb5_wrapper ...restored
