# 180421 ***forced to make copy of meta/recipes-multimedia/ffmpeg***
# why does it only have --enable-outdev=xv ? -- removing that line.
# enable mp3lame
# added --pkg-config=, see note in .bbappend THIS FIXED IT!
...
PACKAGECONFIG ??= "avdevice avfilter avcodec avformat swresample swscale postproc \
                   bzlib gpl lzma theora x264 mp3lame \
